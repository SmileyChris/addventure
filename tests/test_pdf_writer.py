...
def test_serialize_top_level_keys():
    ...
    assert set(data.keys()) == {"metadata", "verbs", "rooms", "inventory_slots", "cue_slots", "signal_checks", "signal_slots", "signal_has_incoming", "potentials", "ledger", "hidden_ledger", "start_room", "ledger_prefix", "blind", "jigsaw", "sealed_texts"}
