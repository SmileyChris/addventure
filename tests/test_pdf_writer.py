...
def test_serialize_top_level_keys():
    ...
    assert set(data.keys()) == {"metadata", "verbs", "rooms", "inventory_slots", "cue_slots", "signal_checks", "signal_slots", "potentials", "ledger", "start_room", "entry_prefix", "blind", "jigsaw", "sealed_texts"}
